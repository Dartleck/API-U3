...
Route::middleware(['auth', 'cliente'])->group(function () {
    ...
    Route::get('/cliente/productos/crear', [ProductoController::class, 'create'])->name('Cliente.productos.crear');
    // Ruta para manejar la creación de productos
    Route::post('/cliente/productos', [ProductoController::class, 'store'])->name('Cliente.productos.store');
    // Ruta para mostrar el formulario de edición de productos
    Route::get('/cliente/productos/{producto}/editar', [ProductoController::class, 'edit'])->name('Cliente.productos.edit');
    // Ruta para manejar la actualización de productos
    Route::put('/cliente/productos/{producto}', [ProductoController::class, 'update'])->name('Cliente.productos.update');
    // Ruta para manejar la eliminación de productos
    Route::delete('/cliente/productos/{producto}', [ProductoController::class, 'destroy'])->name('Cliente.productos.destroy');
